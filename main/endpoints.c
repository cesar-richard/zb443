...
static uint8_t BASIC_SW_BUILD[] = {5, '1','.','0','.','0'};
...
void create_endpoints(void)
{
    ...
    // Button 1 endpoint (On/Off Switch - Portail Principal)
    ...
    // Button 2 endpoint (On/Off Switch - Portail Parking)
...
void handle_button_click(uint8_t endpoint)
{
    ...
    case BUTTON_1_ENDPOINT:
        ...
        came433_send_portail1(); // Envoyer code CAME pour Portail Principal

        break;
    case BUTTON_2_ENDPOINT:
        ESP_LOGI(TAG, "Button 2 clicked - Portail Parking");
        came433_send_portail2(); // Envoyer code CAME pour Portail Parking
